...
export const FinancialReports: React.FC = () => {
  ...
  const renderOverview = () => {
    ...
    const cards = [
      ...
      { label: '总购买价值', value: formatCurrency(s.totalPurchaseValue), sub: `实际价格 ${formatCurrency(s.totalPurchasePrice)} · 其他费用 ${formatCurrency(s.totalPurchaseFees)}`, icon: <Building2 size={20} />, bg: 'bg-accent/15', color: 'text-accent' },
