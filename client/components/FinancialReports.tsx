...
export const FinancialReports: React.FC = () => {
  ...
  const renderOverview = () => {
    ...
    const cards = [
      ...
      ...(s.totalMarketValue > 0 ? [{ label: '总市值', value: formatCurrency(s.totalMarketValue), sub: `增值 ${formatCurrency(s.totalMarketValue - s.totalPurchasePrice)} (${s.totalPurchasePrice > 0 ? ((s.totalMarketValue - s.totalPurchasePrice) / s.totalPurchasePrice * 100).toFixed(1) : '0'}%)`, icon: <TrendingUp size={20} />, bg: 'bg-success/15', color: 'text-success' }] : []),
